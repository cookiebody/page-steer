...
"We" in this document refers to the maintainers of the open-source Page Steer project (https://github.com/cookiebody/PageSteer). "The software" refers to Page Steer (the JavaScript library) and Page Steer Ext (the browser extension). This document covers the software itself and the testing API we provide — **not** any third-party product or service built with it.
...
The project is open source under the [MIT License](https://github.com/cookiebody/PageSteer/blob/main/LICENSE) and can be audited at: https://github.com/cookiebody/PageSteer
...
- **Independent Infrastructure**: The software is completely frontend-based with a "Bring Your Own Key" (BYOK) architecture and **no built-in backend**. To facilitate easy testing, the maintainers provide a public cloud-based proxy service. This project is independently maintained and not a product of, nor endorsed by, any cloud provider.
...
## 3. Browser Extension (Page Steer Ext)
...
https://github.com/cookiebody/PageSteer/issues
