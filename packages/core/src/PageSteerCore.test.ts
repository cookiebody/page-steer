...
import { PageSteerCore, tool } from './PageSteerCore'
...
function createAgent(
	...
	options: Partial<ConstructorParameters<typeof PageSteerCore>[0]> = {}
): PageSteerCore {
	return new PageSteerCore({
...
describe.concurrent('PageSteerCore lifecycle', () => {
