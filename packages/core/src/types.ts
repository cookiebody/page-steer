...
import type { PageSteerCore } from './PageSteerCore'
import type { PageSteerTool } from './tools'

/** Supported response languages */
export type SupportedLanguage = 'en-US' | 'zh-CN' | 'ja-JP' | 'fr-FR'
...
export interface AgentConfig extends LLMConfig {
	...
	/**
	 * Enable verbose internal logging for debugging agent runs.
	 * @default false
	 */
	debug?: boolean

	/**
	 * Custom tools to extend PageSteer capabilities
	 * @experimental
	 ...
	 * 		question: z.string(),
	 * 	}),
	 * 	execute: async function (this: PageSteer, input) {
	 ...
	 * }
	 */
	customTools?: Record<string, PageSteerTool | null>
	 ...
	 * @experimental
	 * @param agent - The PageSteerCore instance
	 * @param stepCount - Current step number (0-indexed)
	 */
	onBeforeStep?: (agent: PageSteerCore, stepCount: number) => Promise<void> | void
	 ...
	 */
	onAfterStep?: (agent: PageSteerCore, history: HistoricalEvent[]) => Promise<void> | void
	 ...
	 * @param agent - The PageSteerCore instance
	 */
	onBeforeTask?: (agent: PageSteerCore) => Promise<void> | void
	 ...
	 */
	onAfterTask?: (agent: PageSteerCore, result: ExecutionResult) => Promise<void> | void
	 ...
	 */
	onDispose?: (agent: PageSteerCore, reason?: string) => void
