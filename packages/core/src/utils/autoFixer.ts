import { InvokeError, InvokeErrorTypes } from '@page-steer/llms'
import chalk from 'chalk'
import * as z from 'zod/v4'

import type { PageSteerTool } from '../tools'

const log = console.debug.bind(console, chalk.yellow('[autoFixer]'))
 ...
 * - etc.
 */
export function normalizeResponse(response: any, tools?: Map<string, PageSteerTool>): any {
 ...
 */
function validateAction(action: any, tools: Map<string, PageSteerTool>): any {
