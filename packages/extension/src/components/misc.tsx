import type { AgentStatus } from '@page-steer/core'
...
export function Logo({ className }: { className?: string }) {
	return <img src="/assets/page-steer-logo.svg" alt="Page Steer" className={cn('', className)} />
}
	...
	return (
		<div className="flex flex-col items-center justify-center h-full gap-4 text-center px-6">
			<div className="relative select-none pointer-events-none">
				...
				<Logo className="relative size-28 opacity-80" />
			</div>
			<div>
				<h2 className="text-base font-medium text-foreground mb-1">Page Steer</h2>
				<TypingAnimation
			...
			<div className="flex items-center gap-3 mt-1 text-muted-foreground">
				...
				<a
					href="https://cookiebody.github.io/docs/page-steer/docs/features/chrome-extension"
					target="_blank"
					rel="noopener noreferrer"
					className="hover:text-foreground transition-colors"
					title="Documentation"
