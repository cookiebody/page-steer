...
export class SimulatorMask extends EventTarget {
	...
	constructor() {
		...
		this.wrapper.id = 'page-steer-runtime_simulator-mask'
		this.wrapper.className = styles.wrapper
		this.wrapper.setAttribute('data-browser-use-ignore', 'true')
		this.wrapper.setAttribute('data-page-steer-ignore', 'true')
		...
		window.addEventListener('PageSteer::MovePointerTo', movePointerToListener)
		window.addEventListener('PageSteer::ClickPointer', clickPointerListener)
		window.addEventListener('PageSteer::EnablePassThrough', enablePassThroughListener)
		window.addEventListener('PageSteer::DisablePassThrough', disablePassThroughListener)

		this.addEventListener('dispose', () => {
			window.removeEventListener('PageSteer::MovePointerTo', movePointerToListener)
			window.removeEventListener('PageSteer::ClickPointer', clickPointerListener)
			window.removeEventListener('PageSteer::EnablePassThrough', enablePassThroughListener)
			window.removeEventListener('PageSteer::DisablePassThrough', disablePassThroughListener)
		})
	}
