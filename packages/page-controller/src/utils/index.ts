...
export async function movePointerToElement(element: HTMLElement, x: number, y: number) {
	...
	window.dispatchEvent(
		new CustomEvent('PageSteer::MovePointerTo', {
...
export async function clickPointer() {
	window.dispatchEvent(new CustomEvent('PageSteer::ClickPointer'))
}

export async function enablePassThrough() {
	window.dispatchEvent(new CustomEvent('PageSteer::EnablePassThrough'))
}

export async function disablePassThrough() {
	window.dispatchEvent(new CustomEvent('PageSteer::DisablePassThrough'))
}
