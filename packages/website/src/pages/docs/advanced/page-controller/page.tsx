		...
		<div>
			...
			<section className="mb-10">
				...
				<p className="text-gray-600 dark:text-gray-400 mb-4">
					{isZh
						? 'PageSteer 接受 PageController 配置项：'
						: 'PageSteer accepts PageController options:'}
				</p>
				<CodeEditor
					language="typescript"
...
const agent = new PageSteer({
  ...
  viewportExpansion: 0,
				...
				<p className="text-gray-600 dark:text-gray-400 mt-4">
					{isZh
						? 'PageSteerCore 接受 PageController 实例：'
						: 'PageSteerCore accepts a PageController instance:'}
				</p>
				<CodeEditor
					language="typescript"
					...
					properties={[
						{
							...
							defaultValue: 'false',
							description: isZh
								? '启用视觉遮罩覆盖层，在自动化期间阻止用户操作页面。通过 PageSteer 创建时默认为 true。'
								: 'Enable visual mask overlay that blocks user interaction during automation. Defaults to true when created via PageSteer.',
						},
						{
  ...
  message: string
			...
			<section className="mb-10">
				...
				<CodeEditor
					language="typescript"
					code={`import { PageSteerCore } from '@page-steer/core'
import type { PageController } from '@page-steer/page-controller'
