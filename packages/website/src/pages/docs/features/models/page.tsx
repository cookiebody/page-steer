...
`}
			...
			<section className="mb-10">
				...
				<p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
					{isZh
						? '以下免费测试接口仅供 PageSteer.js 和 PageSteer Extension 的技术评估和测试使用。'
				...
				<div className="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-5 border border-gray-200 dark:border-gray-800">
					...
					<CodeEditor
						code={`# Configure your own LLM endpoint
...
LLM_MODEL_NAME="your-model-name"`}
			...
			<section className="mb-10">
				...
				<CodeEditor
					code={`const agent = new PageSteer({
			...
			<section className="mb-10">
				...
				<div className="space-y-6">
					<section>
						...
						<CodeEditor
							language="typescript"
							code={`const pageSteer = new PageSteer({
        ...
        ...restMessages,
			...
			<section className="mb-10">
				...
				<p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
					{isZh
						? '通过 Ollama、LM Studio 等本地 OpenAI-compatible 运行时接入 PageSteer，实现离线或局域网部署。'
						: 'Use local OpenAI-compatible runtimes such as Ollama and LM Studio with PageSteer for offline or LAN deployments.'}
				</p>
...
const lmStudioAgent = new PageSteer({
