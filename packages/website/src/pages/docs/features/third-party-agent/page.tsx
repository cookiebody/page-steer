	...
	return (
		<div>
			...
			<p className="mb-6 leading-relaxed text-gray-600 dark:text-gray-300">
				{isZh
					? '将 pageSteer 作为工具接入你的答疑助手或 Agent 系统，成为你 Agent 的眼和手。'
					: 'Integrate pageSteer as a tool in your support assistant or Agent system, becoming the eyes and hands of your Agent.'}
			</p>
...
const pageSteerTool = {
  ...
  execute: async (params) => {
    const result = await pageSteer.execute(params.instruction)
