...
import PageSteerCoreDocs from './advanced/page-steer-core/page'
// Advanced
import PageSteerDocs from './advanced/page-steer/page'
...
export default function DocsRouter() {
	return (
		<Switch>
			...
			{/* Advanced */}
			<Route path="/advanced/page-steer">
				<DocsPage>
					<PageSteerDocs />
				</DocsPage>
			</Route>
			<Route path="/advanced/page-steer-core">
				<DocsPage>
					<PageSteerCoreDocs />
				</DocsPage>
			</Route>
