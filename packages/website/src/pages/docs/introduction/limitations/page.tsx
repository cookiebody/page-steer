		...
		<div className="max-w-4xl mx-auto">
			<div className="mb-8">
				...
				<p className="text-xl text-gray-600 dark:text-gray-300">
					{isZh
						? 'Page Steer 基于 DOM 理解网页并执行操作。这决定了它的能力边界。'
						: 'Page Steer understands web pages via DOM and performs actions accordingly. This defines its capability boundary.'}
				</p>
			</div>

			<div className="prose prose-lg dark:prose-invert max-w-none">
				{/* PageSteer.js vs PageSteerExt */}
				<Heading id="pageagent-js-vs-pageagentext" className="text-2xl font-bold mb-3">
					{isZh ? 'PageSteer.js vs PageSteerExt' : 'PageSteer.js vs PageSteerExt'}
				</Heading>
				<p className="text-gray-600 dark:text-gray-300 mb-4">
					{isZh
						? 'PageSteer.js 是核心库，运行在页面内。PageSteerExt 是可选的浏览器扩展，提供额外的浏览器级控制能力。'
						: 'PageSteer.js is the core library running inside a page. PageSteerExt is an optional browser extension that adds browser-level control.'}
				</p>
					...
					<table className="w-full text-sm border-collapse">
						<thead>
							<tr className="border-b border-gray-200 dark:border-gray-700">
								...
								<th className="text-left py-3 px-4 font-semibold">PageSteer.js</th>
				...
				<p className="mb-2 font-medium">
					{isZh
						? 'Page Steer 不使用多模态模型，不截图，没有视觉能力。仅通过 DOM 结构理解页面。'
						: 'Page Steer does not use multimodal models, does not take screenshots, and has no visual capability. It reads pages through DOM structure only.'}
				</p>
				<p className="mb-2 font-medium">
					{isZh
