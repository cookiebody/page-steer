	...
	return (
		<div>
			...
			<p className=" mb-6 leading-relaxed">
				{isZh ? '几分钟内完成 page-steer 的集成。' : 'Integrate page-steer in minutes.'}
			</p>
			...
			<div className="space-y-4 mb-6">
				...
				<div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
					...
					<p className="text-sm text-gray-600 dark:text-gray-300 mb-3">
						{isZh
							? '在 URL 后添加 ?autoInit=false 可只加载脚本，不自动创建 Demo Agent；之后可通过 new window.PageSteer(...) 手动初始化。'
							: 'Add ?autoInit=false to load the script without creating the demo agent automatically. You can then instantiate it with new window.PageSteer(...).'}
					</p>
