	...
	return (
		<ol className="list-decimal pl-5 space-y-4 text-gray-700 dark:text-gray-300">
			<li>
				...
				<p className="mt-1">
					{isZh
						? '并非所有模型都能正确处理 page-steer 的 tool 定义。请查看'
						: 'Not all models can handle page-steer tool definitions correctly. Check the '}
					<Link
				...
				<p className="mt-1">
					{isZh ? (
						<>
							如果以上步骤无法解决问题，欢迎在{' '}
							<a
								href="https://github.com/cookiebody/PageSteer/issues"
								target="_blank"
