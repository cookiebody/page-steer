			...
			<div className="max-w-4xl mx-auto text-center">
				<BlurFade inView>
					...
					<p className="text-sm text-gray-500 dark:text-gray-400 mb-12 max-w-2xl mx-auto">
						{'* '}
						{isZh
							? 'PageSteer.js 本身无需任何扩展即可工作，扩展是额外的能力增强。'
							: 'PageSteer.js works without any extension — this is a power-up, not a dependency.'}
					</p>
				</BlurFade>

				<div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
					<a
						href="https://chromewebstore.google.com/detail/page-steer-ext/akldabonmimlicnjlflnapfeklbfemhj"
						target="_blank"
