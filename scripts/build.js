 ...
 *                    && npm run build:website -w @page-steer/website
 *                    && npm run zip -w @page-steer/ext
 *
 * 1. cleanup
...
tasks.push(
	{
		label: '@page-steer/website',
		command: 'npm run build:website',
		cwd: join(rootDir, 'packages/website'),
	},
	{ label: '@page-steer/ext', command: 'npm run zip', cwd: join(rootDir, 'packages/extension') }
)
