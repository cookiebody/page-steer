...
/**
 * Check if a dependency name is a page-steer internal package
 */
function isInternalPackage(name) {
	return name === 'page-steer' || name.startsWith('@page-steer/')
}
...
const CDN_DEMO_URL_OLD = `https://cdn.jsdelivr.net/npm/page-steer@${oldVersion}/dist/iife/page-steer.demo.js`
const CDN_DEMO_URL_NEW = `https://cdn.jsdelivr.net/npm/page-steer@${newVersion}/dist/iife/page-steer.demo.js`
const CDN_DEMO_CN_URL_OLD = `https://registry.npmmirror.com/page-steer/${oldVersion}/files/dist/iife/page-steer.demo.js`
const CDN_DEMO_CN_URL_NEW = `https://registry.npmmirror.com/page-steer/${newVersion}/files/dist/iife/page-steer.demo.js`
